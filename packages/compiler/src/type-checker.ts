...
/**
 * Helper: Check action type constraints
 */
const checkActionTypes = (action: ActionIR): Effect.Effect<void, TypeError> =>
    Effect.gen(function* (_) {
...
/**
 * T061: Check numeric duration constraints in action properties
 */

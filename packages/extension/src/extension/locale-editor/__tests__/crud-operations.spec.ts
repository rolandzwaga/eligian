/**
 * Locale Editor CRUD Operations Tests (Feature 036, User Story 2)
 *
 * Tests verify CRUD operations by testing the ACTUAL production code
 * exported from locale-editor-core.ts:
...
} from '../../../../media/locale-editor-core.js';

describe('Locale Editor CRUD Operations (Feature 036, User Story 2)', () => {

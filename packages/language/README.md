...
- [src/eligian.langium](src/eligian.langium) -  The grammar definition of your language
- [src/eligian-module.ts](src/eligian-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/eligian-validator.ts](src/eligian-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/eligian.monarch.ts](src/syntaxes/eligian.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/eligian.tmLanguage.json](syntaxes/eligian.tmLanguage.json) - Textmate based syntax highlighting instructions.

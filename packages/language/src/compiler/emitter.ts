...
export const emitJSON = (ir: EligiusIR): Effect.Effect<IEngineConfiguration, EmitError> =>
  Effect.gen(function* (_) {
    ...
    const baseConfig: IEngineConfiguration = {
    ...
    // Add $schema for JSON Schema validation and IDE support
    // Note: IEngineConfiguration doesn't define $schema, but JSON Schema spec allows it
    const config = {

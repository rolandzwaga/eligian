...
export function registerValidationChecks(services: EligianServices) {
  ...
  const checks: ValidationChecks<EligianAstType> = {
    ...
    EventActionDefinition: [
      ...
      validator.checkEventNameExists, // T034: Event name validation with suggestions (US1)
      validator.checkEventArgumentCount, // US2: Argument count validation
      validator.checkEventTypeCompatibility, // US3: Type compatibility validation (T038-T055)
    ],
  };
